...
import { FleetChiefRutasStyled } from "./styles";
import useFilters from "./hooks/useFilters";
import useFleetChiefRutas from "./hooks/useFleetChiefRutas";
import useFleetChiefRutasTab from "./hooks/useFleetChiefRutasTab";
...
export default function FleetChiefRutas() {
  ...
  const {
    ...
    tableDataRoutes,
  } = useFleetChiefRutas(activeFilters);

  const { tabSeletect, handleOnClickTab } = useFleetChiefRutasTab();
  return (
    <FleetChiefRutasStyled>
