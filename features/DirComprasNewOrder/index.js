...
export default function DirComprasNewOrder() {
  ...
  const { viewControl, formControls, catalogs, modalControl, provider, handleBack } = useMain({
    productControl,
    paymentsControl,
  });
  ...
  const views = {
    ...
    orderData: <FormOrder formControls={formControls} catalogs={catalogs} viewControl={viewControl} />,
    products: (
      <FormProducts
        provider={provider}
  ...
  return (
    <NewOrderStyle>
      ...
      <div className="main_order">
        ...
        <div className="fixed">
          <div className="flex-center-end">
            ...
            >
              {viewControl.isCreating ? "Guardando cambios" : "Guardar cambios (borrador)"}
            </Button>
            ...
            >
              {viewControl.isCreating ? "Guardando cambios" : "Guardar y salir (finalizar)"}
            </Button>
          </div>
        </div>
      </div>
      ...
      <DrawerSerialNumbers
        ...
        handletoogle={productControl.toggleModalNumers}
