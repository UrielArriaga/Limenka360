...
import useMasterAdminTrackings from "./hooks/useMasterAdminTrackings";
import useFilters from "./hooks/useFilters";
import useMasterAdminFiles from "./hooks/useMasterAdminFiles";
import useMasterPedidoProgress from "./hooks/useMasterPedidoProgress";
import useMasterAdminPedidosProgress from "./hooks/useMasterAdminPedidosProgress";
...
export default function MasterPedidosEnProceso() {
  ...
  const {
    ...
    refetchData,
    updateStateData,
  } = useMasterAdminPedidosProgress(activeFilters, inventoryExitId);
  ...
  const {
    ...
    updateStateProducts,
    generatePDF,
  } = useMasterPedidoProgress(orderSelected, null, updateStateData);
  ...
  const {
    ...
    articleSelected,
  } = useMasterAdminFiles(orderSelected);
  ...
  const {
    ...
    orderByTracking,
    setOrderByTracking,
  } = useMasterAdminTrackings(orderSelected);
  ...
  // newDate es un nuevo arreglo con la infromacion del la orden seleccioanda y el articulo seleccionado para agrgarlo a la preview y aal template
