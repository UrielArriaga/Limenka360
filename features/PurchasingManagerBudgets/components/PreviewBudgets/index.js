      ...
      <div className="headerpreview">
        ...
        <div className="headerpreview__listactions">
          ...
          <div className="headerpreview__listactions--item">
            <Button
              className={`${data?.assignedbyId ? "btn_disabled" : "button"}`}
              disabled={data?.assignedbyId}
              onClick={() => handleAssing(data)}
            >
              Asignar
            </Button>
          </div>
      ...
      <div className="contentpreview">
        ...
        >
          <div>
            ...
            <p>
              Asignado a: <span>{data?.assignedby?.fullname ? data?.assignedby?.fullname : "N/A"}</span>
            </p>
          </div>
        </div>
