...
export default function useProducts(oportunity) {
  ...
  const fetchProducts = async () => {
    try {
      let respProducts = await productsService.getProductsByOportunity(oportunity.id);
