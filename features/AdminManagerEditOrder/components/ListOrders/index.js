...
import { getColor, getColorStatusOrder } from "../../utils";
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: getColorStatusOrder(item.orderstatus).bgColor,
                  }}
                >
                  <p
                    style={{
                  ...
                  >
                    {/* {item.orderstatus} */}
                    {item.orderstatus === "Pendiente de aprobación" ? "Pendiente" : item.orderstatus}
                  </p>
                </div>
              </div>
            );
