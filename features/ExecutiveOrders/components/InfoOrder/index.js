...
export default function InfoOrders({ oportunity, step, order,selectedTypeSale }) {
  ...
  return (
    <InfoOrdersStyled container>
      <div className="sectionheader">
        <h1 className="title">Datos de la Venta {oportunity?.concept}. </h1>
