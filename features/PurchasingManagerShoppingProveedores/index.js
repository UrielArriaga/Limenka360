...
export default function PurchasingManagerShoppingProveedores({ isAdmin = false }) {
    ...
    <DirLogDashboardStyled>
      ...
      <div className="headerTitle">
        <div className="header">
          ...
          <Button className="add" onClick={() => router.push("../coordinadorcompras/proveedores/nuevo")}>
            <Add />
            Agregar Proveedor
          </Button>
        </div>
