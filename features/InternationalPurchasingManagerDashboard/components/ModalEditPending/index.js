...
export default function ModalEditPending({ openModalEdit, toggleModalEdit, slotToEdit, updatePending, modalFinish }) {
      ...
      <form onSubmit={handleSubmit(onSubmitEdit)}>
        <StylesDirectModalEditEvent>
          ...
          <div className="content_inputs">
            ...
            />
            <p className="name_title">
              Ejecutive: {errors?.ejecutiveName && <span style={{ color: "red" }}>*Requerido</span>}
            </p>
            <Controller
              name="ejecutiveName"
              control={control}
          ...
          <DialogActions>
            {!isEditable ? (
              <>
                <Button onClick={()=> { modalFinish?.toggleModal(), toggleModalEdit()}} color="primary" className="button edit">
                  Finalizar
                </Button>
                <Button onClick={enableEditing} color="primary" className="button edit">
                  Editar
                </Button>
              </>
            ) : (
              <>
                <Button
                  onClick={() => {
                    toggleModalEdit(), reset(), setIsEditable(false);
                  }}
                  color="primary"
