...
export default function useMasterEntrance(productInventorySelected, tabSeletect) {
  ...
  useEffect(() => {
    const getProductsInventoryEntry = async () => {
      try {
        ...
        const resData = (await DirLogInventaryUnitEntrance.getProductsInventoryEntry(query)).data;
