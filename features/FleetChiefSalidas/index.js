...
import ListExits from "./compo/ListExits";
import { DepAttendantExitsStyles } from "./styles";
import PreviewPurchaseExit from "./compo/PreviewPurchaseExit";
...
import ModalFileGenerate from "./compo/ModalFileGenerate";
import ActiveFilters from "./compo/ActiveFilters";
      ...
      <div className="header">
        ...
        <div className="header__filters">
          <div className="inputContainer">
            ...
            />
            {keyword?.length > 3 && (
              <IconButton className="inputContainer__clean" onClick={() => setKeyword("")}>
                <Close />
              </IconButton>
            )}
          </div>
