...
import { getStatusIcon } from "../../Biomedica/utils";
    ...
    try {
      ...
      if (keyword.length > 2 && selectedProduct) {
        ...
        if (selectedProduct == "serialnumber") {
          query = { serialnumber: { $iRegexp: keyword.trim() } };
        }
      ...
      return (
        <div
          ...
          style={{
            ...
            padding: "2px 10px",
            borderRadius: 15,
            background: `${item?.intransit == "No Aplica" ? "#ff0101" : "#017E03"}`,
          }}
        >
          <p
            className="name"
...
let heads = [
  ...
  {
    headText: "En Transito",
    headNormalize: "intransit",
    orderby: null,
  },
