...
export default function ShoppingNacionalBuyOrders({ isAdmin = false }) {
  ...
  const { isFetchingOrder, orderSelectedData, getDataOrder, handleDateChange, handleSelectChange } = useShippingOrder(
    orderSelected,
    dataProducts
  );
  ...
  return (
    <StyledOrders>
      ...
      <PaymentsDrawer
        ...
        payments={payments}
        setEdit={setEdit}
        fetchDataPaymentsPurchaseOrder={fetchDataPaymentsPurchaseOrder}
        generatePreview={generatePreview}
        handleChange={handleChange}
        paymentPeriods={paymentPeriods}
        setPaymentsPurchase={setPaymentsPurchase}
