...
export class OrdersServices {
  ...
  async getOrder(id) {
    let params = {
      include:
        "oportunity,oportunity.productsoportunities,address,address.entity.city.postal,bill,bill.cfdi,bill.paymentmethod,bill.paymentway,bill.address,bill.taxregime,createdbyid,createdbyid.group",
    };
  ...
  async getWareProductsOrder(orderId) {
    if (!orderId) {
      throw new Error("orderId is required");
    }
