...
export default function ModalFinishPending({ modalFinish, finishPending }) {
  const {
    control,
    handleSubmit,
    reset,
          ...
          <div className="contentForm">
            <div className="content_inputs">
              <p className="name_title">
                Razon: {errors?.reason ? <span className="errorRequeried">* Requerido</span> : ""}
              </p>
              <Controller
                name="reason"
                control={control}
              ...
              />
              <p className="name_title">
                Comentario: {errors?.observations ? <span className="errorRequeried">* Requerido</span> : ""}
              </p>
              <Controller
                name="observations"
                control={control}
