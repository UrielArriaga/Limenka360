    ...
    <PreviewRecolecionStyled>
      <div className="headerpreview">
        ...
        <div className="headerpreview__listactions">
          ...
          <div className="headerpreview__listactions--item">
            <Button
              className={` button ${dataDelivery?.data?.delivered ? "buttondisabled" : ""}`}
              disabled={dataDelivery?.data?.delivered ? true : false}
              onClick={() => {
              handleOnClickSaveDelivery(routeSelected?.data);
              }}
            >
              {dataDelivery?.data?.delivered ? "Entregado" : "Marcar Entregado"}
            </Button>
          </div>
          {/* <div
