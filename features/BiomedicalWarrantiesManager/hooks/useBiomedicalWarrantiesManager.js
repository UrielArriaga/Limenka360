...
import ApiAdminBiomedicalWarranties from "../services";
import dayjs from "dayjs";

function useBiomedicalWarrantiesManager(activeFilters) {
    const [keyword, setKeyword] = useState("");
    const request = new ApiAdminBiomedicalWarranties(); 
...
export default useBiomedicalWarrantiesManager;