...
class DirLogRecolecionApi {
  async getpickuppurchaseorder(limit = 20, page = 1, orderBy, query) {
    let params = {
      include: "order,statuspoo,purchaseorder,purchaseorder.provider,purchaseorder.statuspoo,purchaseorder.provideraddress,purchaseorder.provideraddress.city,purchaseorder.provideraddress.entity,supply,supply.product",
      join: "order,statuspoo,purchaseorder,purchaseorder.provider,purchaseorder.statuspoo,purchaseorder.provideraddress,purchaseorder.provideraddress.city,purchaseorder.provideraddress.entity,supply,supply.product",
      limit: limit,
      skip: page,
      count: 1,
      order: orderBy,
