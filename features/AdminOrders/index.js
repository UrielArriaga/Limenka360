...
import ModalCanceledOrder from "./components/ModalCanceledOrder";
import ModalEditAccountPay from "./components/ModalEditAccountPay";

export default function AdminOrders({ orderStatus = "Pendiente de aprobación" }) {
  ...
  const {
    ...
    deleteKeyWord,
    refetchData,
  } = useDirLogPedidos(activeFilters, setActiveFilters, orderStatus);
  ...
  return (
    <AdminManagerOrdersStyled isFilterActive={activeFilters?.length > 0}>
      ...
      <ModalEditAccountPay
        ...
        orderSelectedData={orderSelectedData}
        updateAccountOfOrder={updateAccountOfOrder}
      />
