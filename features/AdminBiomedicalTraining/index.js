...
import PreviewBiomEdit from "./components/PreviewBiomEdit"
import useFormationEdit from "./hooks/useFormationEdit";


function AdminBiomedicalTraining() {
  ...
  const { trainingProducts, modalBioEdit, optionSct, assignResponsible } = useFormationEdit(selectedTraining);
    ...
    <BiomedicaFormationStyles>
      ...
      <div className="main">
        <Grid container>
          ...
          {/* <PreviewBiomEdit
             open={modalBioEdit?.isAssignBioOpen}
             handleToggle={modalBioEdit?.toggleAssignBioModal}
             optionSct={optionSct}
...
export default AdminBiomedicalTraining;
