            ...
            <div className="table">
              ...
              {products?.isFetching == true ? (
                ...
                <div className="tablebody">
                  {products?.data?.map((article, index) => (
                    <div
                      key={index}
                      onClick={() => handleClickAddProduct(article, index)}
                      className={`tablerow-container ${index % 2 === 0 ? "even-row" : "odd-row"}`}
                    >
                      <div className="tablerow">
                        ...
                        <div className="tablecell tableheadproductrow">
                          <div className="content">{article?.product?.name}</div>
                        </div>
                        <div className="tablecell code">{article?.product?.stock}</div>
