...
export default function AdminBiomedicalWarranties() {
    ...
    const { keyword, handleOnChangeKeyWord, deleteKeyWord, paginationData, warranties, handleOnClickRow,
        tableData, setIsOpenPreview, isOpenPreview, refetchData, warrantySelected } = useAdminBioWarranties(activeFilters);

    return (
        <AdminBiomedicalWarrantiesStyled>
