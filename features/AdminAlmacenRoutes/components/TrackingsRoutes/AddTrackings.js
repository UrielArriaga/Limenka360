...
import useNewTrackingRoutes from "../../hooks/useNewTrackingRoutes";
...
export default function AddTrackings({ orderSelectedData, reloadTrackings, setShowAddForm }) {
  const { register, handleSubmit, errors, handleAddTracing, resetForm, loadingCreated } = useNewTrackingRoutes({
    orderSelectedData,
    reloadTrackings,
    setShowAddForm,
  });
      ...
      <div className="add-tracking">
        ...
        >
          <div className="headerAdd">
            <p className="titleAdd">Agregar Datos Nuevo Seguimiento.</p>
