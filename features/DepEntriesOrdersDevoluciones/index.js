...
function DepDevoluciones() {
  ...
  const { dataEntrance, isFetchingEntrance, paginationDataEntrance, open, toggleModal, generateEntry } =
    useDirLogEntrance(routeSelected);
  ...
  return (
    <DirLogRutasStyled>
      ...
      <ModalEntry generateEntry={generateEntry} closeModal={toggleModal} openModal={open} />
    </DirLogRutasStyled>
  );
}

export default DepDevoluciones;
