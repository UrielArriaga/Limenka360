...
const renderPreview = (template, data) => {
  ...
  switch (template) {
    //
    case "meison medical cristian": //krispy kreme
    ...
    case "chison mexico": //ChisonMexicoGarantia
      return <ChisonMexicoGarantia data={data} />; // falta este template
      case "ultrasonidos carlos": //ChisonMexicoGarantia
      return <ChisonMexicoGarantia data={data} />; // falta este template
...
export default function ModalFileGenerate({
  ...
  useEffect(() => {
    ...
    console.log("group", groupNameOrder);
  }, [newDate,groupNameOrder]);
