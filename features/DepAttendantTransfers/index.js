...
import useDepAttendantTransfers from "./hooks/useDepAttendantTransfers";
import useFilters from "./hooks/useFilters";
import useDepAttendantTransferProducts from "./hooks/useDepAttendantTransferProducts";
import ModalExit from "./components/ModalCreateExit";

function DepAttendantTransfers({ isAdmin = false, status }) {
  ...
  const {
    ...
    lastFetchDate,
    selectedTransfer,
  } = useDepAttendantTransfers(activeFilters, isAdmin, status, setActiveFilters, setproductoportunityorder);
  ...
  const {
    ...
    setObservations,
    handleOnSaveExit,
  } = useDepAttendantTransferProducts(selectedTransfer);
...
export default DepAttendantTransfers;
