...
import { ShoppingNacionalOrdersStyles } from "./styles";
...
export default function ShoppingNacionalOrders({ isAdmin = false }) {
  ...
  return (
    <ShoppingNacionalOrdersStyles isFilterActive={activeFilters?.length > 0}>
