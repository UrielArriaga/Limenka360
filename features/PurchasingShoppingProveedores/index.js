...
import usePurchasingManager from "./hooks/usePurchasingManager";
export default function PurchasingShoppingProveedores({ isAdmin = false }) {
  ...
  const { suplierProvider, removeSupplier, openContact, toggleContact, relations, handleAddContact, stateHookForm } =
  ...
  const {
    ...
    toggleModalView,
    openView,
  } = usePurchasingManager(activeFilters, isAdmin, toggleModaEdit, openEdit, setProviderEdit);
    ...
    <DirLogDashboardStyled>
      ...
      <div className="headerTitle">
        <div className="header">
          ...
          <Button className="add" onClick={() => router.push("../gestorcompras/proveedores/nuevo")}>
            <Add />
            Agregar Proveedor
          </Button>
        </div>
