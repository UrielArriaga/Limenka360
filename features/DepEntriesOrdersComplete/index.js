...
import useDirLogFiles from "./hooks/useDepEntriesFiles";
import useDirLogPedido from "./hooks/useDepEntriesPedido";
import useDirLogPedidos from "./hooks/useDepEntriesPedidos";
import useDirLogTrackings from "./hooks/useDepEntriesTrackings";
...
import useDirLogAssingWereHouse from "./hooks/useDepEntriesAssingWereHouse";
...
export default function DirLogPedidosComplete({ isAdmin = false, status }) {
  ...
  const fetchProducts = async () => {
    try {
      if (!orderSelectedData?.id) return;
