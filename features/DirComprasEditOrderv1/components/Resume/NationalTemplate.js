...
function NationalTemplate(props) {
      ...
      <div className="container">
        <div className="content-wrapper">
          ...
          <div className="table-container">
            <div className="table">
              <div className="table-header">{provider?.companyname}</div>
          ...
          <div className="table-container2">
            <div className="table2">
              ...
              <div className="table-content2">
                ...
                <p className="text">DIRECCIÓN: {buyer?.address}</p>
...
export default NationalTemplate;
