...
import { ordersEntries } from "./data";
...
export default function DepEntriesOrders() {
  const { activeFilters, setActiveFilters, handleOnChangeFilter, filters } = useFilters(ordersEntries);
  ...
  const { orderSelectedData, productsData, handleOnClickNewExit, inventoryExitId, updateStateProducts } =
