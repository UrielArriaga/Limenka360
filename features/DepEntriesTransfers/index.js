...
import useDepEntryTransfers from "./hooks/useDepEntryTransfers";
import useFilters from "./hooks/useFilters";
import useDepEntryTransferProducts from "./hooks/useDepEntryTransferProducts";
import ModalEntry from "./components/ModalCreateEntry";

function DepEntriesTransfers({ isAdmin = false, status }) {
  ...
  const {
    ...
    lastFetchDate,
    selectedTransfer,
  } = useDepEntryTransfers(activeFilters, isAdmin, status, setActiveFilters, setproductoportunityorder);
  ...
  const {
    ...
    setObservations,
    handleOnSaveEntry,
  } = useDepEntryTransferProducts(selectedTransfer);
  ...
  return (
    <DirLogTransfersStyled>
      ...
      <ModalEntry
        ...
        handleOnSaveEntry={handleOnSaveEntry}
      />
    </DirLogTransfersStyled>
  );
}

export default DepEntriesTransfers;
