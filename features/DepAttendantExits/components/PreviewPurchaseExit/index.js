...
export default function PreviewPurchaseExit({
  ...
  console.log("datanuevaa", inventoryExitSelected);
    ...
    <ContainerExitStyled>
        ...
        <div className="headerpreview__listactions">
          <div className="headerpreview__listactions--item">
            <Button
              ...
              onClick={() => {
                if (inventoryExitSelected?.deliveryrouteId != null) return; 
                router.push({
      ...
      <div className="contentpreview">
        <div>
          ...
          <p>
            Folio de Pedido: <span>{inventoryExitSelected?.folio}</span>
          </p>
          <p>
            Folio de Orden: <span>{inventoryExitSelected?.orderFolio}</span>
          </p>
          <p>
        ...
        <NewTrackinsInventory orderData={infOrder} inventoryType="salidas" />
      </div>
    </ContainerExitStyled>
  );
}
