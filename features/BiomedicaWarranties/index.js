...
export default function BiomedicaWarranties() {
    ...
    const { keyword, handleOnChangeKeyWord, deleteKeyWord, paginationData, warranties, handleOnClickRow,
        tableData, setIsOpenPreview, isOpenPreview, refetchData, warrantySelected } = useBioWarranties(activeFilters);

    return (
        <BiomedicaWarrantiesStyled>
