...
function AdminAlmacenPickups() {
  ...
  const { isFetchingExit, dataOutputs, paginationDataOutput, totalOutputs, dataSupplies } = useDirLogOutputs(
    dataEntrance 
);
...
export default AdminAlmacenPickups;
