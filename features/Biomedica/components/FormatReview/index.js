        ...
        <div className="ctr_edit__ctr_info">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Grid container className="form">
              ...
              <Grid item xs="12" className="item">
              <p>Estatus Producto* {errors.revisionDate && <span className="error-message"> Requerido</span>}</p>
              <Controller
               name="indicator"
               control={control}
              ...
              <Select 
              {...field}
              placeholder="Selecciona una opción para semaforo"
              options={indicators}
