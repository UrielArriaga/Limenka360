...
import { Close, Healing, LibraryAddCheck, RestoreFromTrash, Search, UpdateSharp, Visibility } from "@material-ui/icons";
...
export default function DepAttendantInventarioUnit() {
  ...
  const { tabSeletect, handleOnClickTab, isFetchingProduct, orderSelectedData, setFlag, flag } =
