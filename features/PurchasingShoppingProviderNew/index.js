...
export default function PurchasingShoppingProviderNew() {
  const {
    openContact,
    toggleContact,
    relations,
          ...
          <form onSubmit={handleSubmit(handleCreateProspect)}>
            <Grid container className="form">
              ...
              <Grid item xs={12} sm={6} md={3} >
                <div className="item">
                  <div className="ContentTitleandAlert"> 
                    <p>Compañía o Nombre Proveedor<strong>*</strong></p>
                  {errors.companyname && (
                      <>
                        <div className="point"></div> <Error>{errors.companyname?.message}</Error>
                      </>
                    )} </div>
                  <input {...register("companyname", { required: "*Requerido" } )} placeholder="Ingrese nombre de la Compañía" className="input" />
                </div>
              </Grid>
