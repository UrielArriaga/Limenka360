...
import { Error, StyledNewProduct } from "./styled";
...
// import { Error } from "../ShoppingProviderNew/styled";
export default function PurchasingShoppingProductNew() {
                  ...
                  case "Input":
                    return (
                      <Grid key={index} item xs={12} md={6}>
                        <p>
                          {inputItem.label} {inputItem.required && <strong>*</strong> }
                        </p>

                        {errors[inputItem.name] && (
                          <> 
                            <div className="point"> </div>
                            <Error> { errors[inputItem.name].message } </Error> 
                          </>
                        )}
                        
                        <input
                          {...register(inputItem.name, {
                            required: inputItem.required ? "Requerido" : false,
                            ...(inputItem.customValidation || {} ),
                          ...
                          className={
                            ...
                            errors?.[inputItem.name]?.type === "noTrailingSpaces"
