...
export default function useProductNew() {
  ...
  const InputsRegister = [
    ...
    },
    {
      ...
      label: "Nombre",
      name: "name",
      placeholder: "Ingresa nombre del producto, sin espacios al inicio o al final",
      type: "string",
      required: true,
      customValidation: {
        validate: (value) =>
    ...
    },
    {
      ...
      label: "Peso (kgs)",
      name: "weight",
      placeholder: "Ingresa sólo el peso",
      type: "string",
      required: true,
      customValidation: {
        validate: (value) => /^[0-9]*$/.test(value) || "Sólo números y sin espacios"
      },
    },
    {
      inputType: "Input",
      label: "Altura (cms)",
      name: "height",
      placeholder: "Ingresa solo la altura ",
      type: "string",
      required: true,
      customValidation: {
        validate: (value) => /^[0-9]*$/.test(value) || "Sólo números y sin espacios"
    ...
    },
    {
      ...
      label: "Ancho (cms)",
      name: "width",
      placeholder: "Ingresa solo el ancho",
      type: "string",
      required: true,
      customValidation: {
        validate: (value) => /^[0-9]*$/.test(value) || "Sólo números y sin espacios"
    ...
    },
    {
      ...
      label: "Longitud (cms) ",
      name: "length",
      placeholder: "Ingresa solo la longitud",
      type: "string",
      required: true,
      customValidation: {
        validate: (value) => /^[0-9]*$/.test(value) || "Sólo números y sin espacios"
