import { AdminAlmacenTransfersStyled } from "./styles";
...
import useAlmacenTransfers from "./hooks/useDirLogTransfers";
import useFilters from "./hooks/useFilters";
import useAlmacenTransferProducts from "./hooks/useDirLogTransferProducts";

function AdminAlmacenTraspasos({ isAdmin = false, status }) {
  ...
  const {
    ...
    lastFetchDate,
    selectedTransfer
  } = useAlmacenTransfers(activeFilters, isAdmin, status, setActiveFilters, setproductoportunityorder);
  
  const { productsTransfer, isFetching } = useAlmacenTransferProducts(selectedTransfer);

  return (
    <AdminAlmacenTransfersStyled>
...
export default AdminAlmacenTraspasos;
