...
import { filtersEntradas } from "./data";
import useFilters from "./hooks/useFilters";
import  ActiveFilters from "./components/ActiveFilters";


export default function DirLogEntradas() {
  const { activeFilters, setActiveFilters, handleOnChangeFilter, filters } = useFilters(filtersEntradas);
