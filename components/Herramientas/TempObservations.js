...
import OriginsTable from "../TableOrigins";
import ObservationsTable from "../TableObservations";
...
export default function TempObservations(page, isLoading, handleAlert, setAlert) {
  ...
  const navigateCreateNew = () => {
    router.push("../herramientas/plantillasObservaciones/nuevo");
  };
        ...
        <div>
          {filterOrigin !== "" && (
            <Chip
              ...
              label={`${"Buscando por Observación"}`}
              className="chip"
            />
          )}
          {searchKey && (
            <Chip
              ...
              label={`Buscando por Observación:  ${searchKey}`}
              className="chip"
            />
          )}
        </div>
            ...
            <div className="head__title">
              <div className="total">
                <div className="titles">
                  <h1>
                    <Assignment className="icon" /> Observaciones
                  </h1>
                </div>
          ...
          <div className="ctr_filter">
            <div className="ctr_filter__ctr_input">
              <TextField
                ...
                label={searchKey !== "" && "Buscar observación"}
        ...
        <div className="ctr_drawer">
          ...
          <Grid container className="container" spacing={2}>
            <Grid item md={12} className="casilla">
              ...
              <label className="label2"> Buscar por observación</label>
