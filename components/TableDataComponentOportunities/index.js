          ...
          <div className="content ">
            <div className="content__flex">
              <div className="title_name">
                ...
                {itemData.isclient && (
                  <Tooltip title="Cliente" arrow={true}>
                    <HowToReg className="icon_client" />
                  </Tooltip>
                )}
              ...
              <div className="icon-bg">
                {!isRejected && <span className="badge">Rechazada</span>}
                {!isImportant && <span className="badgeImportant">Importante</span>}
            ...
            <div className="content__more">
                  ...
                  if (item.system !== true) {
                    return (
                      <div key={index} className="index">
                        <Tooltip title={toUpperCaseChart(item?.labelname)}>
                          <Chip
                            className="chip"
                            style={{
                              color: "#616161",
              ...
              <div className="txt-pottential">
                {itemData?.isclientpotencial === true && (
                  <div className="index">
                    <Tooltip title="marcado como cliente potencial">
                      <Chip
                        className="chip"
                        avatar={<PersonAdd className="fire" style={{ fontSize: 15, color: "green" }} />}
...
const TableComponent = props => {
  ...
  const saveAndRetrivelocalStorage = () => {
    try {
      ...
      let savedHeads = localStorage.getItem("tableOportunity");
      localStorage.setItem("tableOportunity", JSON.stringify(normalizeHeads));
      if (savedHeads === null || savedHeads === undefined) {
        ...
        if (lengthArray.length === heads.length) {
          ...
          localStorage.setItem("tableOportunity", savedHeads);
        } else {
          setHeadsTable(normalizeHeads);
  ...
  const handleChangeUsersCheck = user => {
    console.log("handleChangeUsersCheck", user);
                        ...
                        <div className="options">
                          {roleId === "gerente" && (
                            <div
                              className="options__option"
                              onClick={() => {
                                handleClickReasignedOportunity(rowSelected);
                                handleCloseActionsRow();
                              }}
                            >
                              <Person />
                              <p>Reasignar Oportunidad</p>
                            </div>
                          )}
                          <div
                            className="options__option"
                          ...
                          <div
                            className="options__option"
                            onClick={() => {
                              handleClickEditToOportunity(rowSelected);
                              handleCloseActionsRow();
                            }}
                          >
                            <Edit />
                          ...
                          <div
                            className="options__option"
                            onClick={() => {
                              handleClickConverToSale(rowSelected);
                              handleCloseActionsRow();
                            }}
                          >
                            <AttachMoney />
                          ...
                          {rowSelected?.rejected === false ? (
                            <div
                              className="options__option"
                              onClick={() => {
                                handleClickRejectOportunity(rowSelected);
                                handleCloseActionsRow();
                              }}
                            >
                              <Clear />
                              <p>Marcar como rechazada</p>
                            </div>
                          ) : (
                            <div
                              className="options__option"
                              onClick={() => {
                                handleCliclRejectedRestore(rowSelected);
                                handleCloseActionsRow();
                              }}
                            >
                              <Restore />
                              <p>Quitar de rechazadas</p>
                            </div>
                          )}

                          {rowSelected?.isimportant === false ? (
                            <div
                              className="options__option"
                              onClick={() => {
                                handleClickImportantOportunity(rowSelected);
                                handleCloseActionsRow();
                              }}
                            >
                              <StarBorder />
                            ...
                            <div
                              className="options__option"
                              onClick={() => {
                                handleCliclImportantRestore(rowSelected);
                                handleCloseActionsRow();
                              }}
                            >
                              <Restore />
                              <p>Quitar de Importantes</p>
                            </div>
                          )}
                          {rowSelected?.isclientpotencial === false ? (
                            <div
                              className="options__option"
                              onClick={() => {
                                handleClickpottential(rowSelected);
                                handleCloseActionsRow();
                              }}
                            >
                              <Clear />
                              <p>Marcar prospecto como cliente potencial</p>
                            </div>
                          ) : (
                            <div
                              className="options__option"
                              onClick={() => {
                                handleClickDeletepottential(rowSelected);
                                handleCloseActionsRow();
                              }}
                            >
                              <Restore />
                              <p>Quitar Prospecto de cliente potencial</p>
                            </div>
                          )}
                          <div
                            className="options__option"
                            onClick={() => {
                              handleClickDiscardOportunities(rowSelected);
                              handleCloseActionsRow();
                            }}
                          >
                            <Delete />
...
const ModalSettings = ({ open, setOpen, headsTable, setHeadsTable, id, heads }) => {
  ...
  const saveUpdatesTable = data => {
    localStorage.setItem("tableOportunity", JSON.stringify(data));
  };
