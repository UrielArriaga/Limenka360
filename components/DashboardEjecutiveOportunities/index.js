...
const DashboardOportunities = ({ handleAlert, type, id_executive }) => {
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={3}>
          <div className="origin_prospect">
            <p className="title">Origen de Oportunidades</p>
            <div className="graph">
        ...
        <Grid item xs={12} md={6}>
          <div className="graph_entity">
            <p className="title">Oportunidades por Estado</p>
            <Line options={optionsEntityProspect} data={dataEntityProspect} />
          </div>
        </Grid>
        <Grid item xs={12} md={3}>
          <div className="origin_prospect">
            <p className="title">Tipo de Cliente de Oportunidades</p>
            <div className="graph">
...
export default DashboardOportunities;
