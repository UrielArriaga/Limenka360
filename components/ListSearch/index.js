...
export default function ListSearch({ focusedIndex, data, handleOnClickItem }) {
      ...
      <div className="items">
        {data.map((item, index) => (
          <div
            ...
            key={index}
            style={{ backgroundColor: index === focusedIndex ? "#dfdfdf" : "" }}
          ...
          >
            {item?.isoportunity == false && item?.isclient == false && (
              <ul className="container">
                ...
                <li className="div">
                  <p className="dates">
                    Datos del Prospecto {item.discarted && <span className="discarted">(Prospecto descartado)</span>}
                  </p>
                  <p className="email">
              ...
              <ul className="container">
                ...
                <li className="div">
                  <p className="dates">
                    ...
                    {item.discarted && <span className="discarted">(Oportunidad descartada)</span>}
                  </p>
                  <p className="email">
                    <span>Nombre:</span>
                    {item?.fullname}
                  ...
                  <p className="amount">
                    <span>Cotizado :</span> {formatDate(item?.oportunityAt)}
                  </p>
                </li>
              </ul>
            )}
            {item?.isclient == true && item?.isoportunity == true && (
              <ul className="container">
                ...
                <li className="div">
                  ...
                  <p className="date">
                    <span>Se hizo cliente en :</span> {formatDate(item?.createdAt)}
                  </p>
                </li>
              </ul>
            )}
