...
export default function VerifyOrder({ ordersVerify, close, open, toggleVerify, refetch, setRefetch }) {
  ...
  const approveOrder = async () => {
    ...
    try {
      let bodyNewTrackingChange = {
        ...
        observations: `El Pedido ${ordersVerify?.folio} fue Verificado.`,
        createdbyId: id_user,
      ...
      if (responseApproved.status === 200) {
        handleGlobalAlert("success", "El Pedido fue verificado correctamente ", "basic", dispatch, 6000);
        toggleVerify();
        ...
        <div className="containerBody">
          <Grid container>
            ...
            <Grid item md={12}>
              <div className="column">
                <div className="row">
                  <p className="content">El pedido {ordersVerify?.folio} se marcara como Verificado.</p>
                </div>
              </div>
            </Grid>
            <Grid item md={12}>
