...
import { calculatePercentaje, formatNumber, generateTemporalId, handleAlert, handleGlobalAlert } from "../../utils";

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction="down" ref={ref} {...props} />;
});

export default function ModalExtraProduct({ open, setOpen, isEditing, itemSelected, setIsEditing }) {
