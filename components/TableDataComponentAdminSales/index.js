        ...
        <TableDataId isPar={isPar} isNew={isNew} className="column_id">
          <div className="content ">
            ...
            <div className="content__more">
              {itemData?.isorder && <p className="order">Pedido realizado</p>}
              <p className="txt-lastracking">
                Ultimo seguimiento <span>{getDiferrenceDates(itemData?.lastTrackingDate)} </span>
              </p>
              <p className="txt-lastracking">Fecha de creación {itemData?.["fecha de venta"]}</p>
            </div>
          </div>
        </TableDataId>
      );
                  ...
                  <div>
                    ...
                    {!discartedTable && (
                      ...
                      >
                        <div className="options">
                          {rowSelected?.isorder && (
                            <div className="options__option" onClick={() => handleClickEditProspect(rowSelected)}>
                              <Edit />
                              <p>Editar</p>
                            </div>
                          )}
