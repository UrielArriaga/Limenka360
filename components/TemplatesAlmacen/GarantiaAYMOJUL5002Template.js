...
function SolucionesHospitalariasGarantia(props) {
      ...
      <div className="container">
        <div className="content">
          <div className="sectionParagraph">
            ...
            <p className="text">
              SOLUCIONES HOSPITALARIAS Hace de su conocimiento que es responsabilidad del cliente reportar o notificar
              ...
              servicio de SOLUCIONES HOSPITALARIAS, dicha cita se tendrá que solicitar al correo:
              garantias@solucioneshospitalarias.com.mx
            </p>
            <p className="text">
              <strong>I.</strong> Esta póliza ampara únicamente productos comercializados por SOLUCIONES HOSPITALARIAS,
        ...
        <div className="content">
          <div className="sectionParagraph">
            ...
            <p className="text">
              <ul className="ul">
                <li className="li">
                  ...
                  aprobados por SOLUCIONES HOSPITALARIAS.
                </li>
                <li className="li">
            ...
            <p className="text">SOLUCIONES HOSPITALARIAS garantiza durante el lapso de meses 12 MESES</p>
...
export default SolucionesHospitalariasGarantia;
...
export const LayoutStyled = styled.section`
  ...
  /* background-image: url("https://crm-desarrollo.sfo3.digitaloceanspaces.com/templates/SOLUCIONES_HOSPITALARIAS.jpeg"); */
