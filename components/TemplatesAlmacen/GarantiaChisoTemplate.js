...
function ChisonMexicoGarantia(props) {
    ...
    <div className="container">
           <div className="content">
             <div className="sectionParagraph">
               ...
               <p className="text">
                 CHISON Hace de su conocimiento que es responsabilidad del cliente reportar o notificar
                 ...
                 servicio de CHISON, dicha cita se tendrá que solicitar al correo:
                 garantias@solucioneshospitalarias.com.mx
               </p>
               <p className="text">
                 <strong>I.</strong> Esta póliza ampara únicamente productos comercializados por CHISON,
           ...
           <div className="content">
             <div className="sectionParagraph">
               ...
               <p className="text">CHISON garantiza durante el lapso de meses 12 MESES</p>
...
export default ChisonMexicoGarantia;
...
export const LayoutStyled = styled.section`
  ...
  .content {
    ...
    position: relative;
    background-image: url("https://crm-desarrollo.sfo3.digitaloceanspaces.com/templates/blackgroundChison.jpeg");
}
