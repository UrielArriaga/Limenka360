      ...
      <div className="container">
        <div className="content">
          <div className="sectionParagraph">
            ...
            <p className="text">
              PROMED hace de su conocimiento que es responsabilidad del cliente reportar o notificar cualquier falla que
              ...
              sea recibida por personal autorizado y facultado para brindar el servicio de PROMED, dicha cita se tendrá
              que solicitar al correo: garantias@elproveedordelmedico.com
            </p>

            <p className="text">
              I. Esta póliza ampara únicamente productos comercializados por PROMED, el tiempo de reparación será en un
        ...
        <div className="content">
          <div className="sectionParagraph">
            ...
            <p className="text">
              <ul>
                <li className="text">
                  I. Toda garantía se invalidará a consecuencia de cualquier trabajo de reparación por parte del cliente
                  o un tercero no autorizado, así mismo, si se utilizan accesorios y componentes no aprobados por
                  PROMED.
                </li>
                <li className="text">
                  II. La alteración, rotura o enmendadura de cualquier sello de seguridad y/o códigos de barras
                  invalidan la garantía, así mismo el quipo deberá tener el mismo número de serie descrito en la
                  presente póliza.
                </li>
                <li className="text">
            ...
            <p className="text">PROMED garantiza durante el lapso de meses 12 MESES</p>
...
export const LayoutStyled = styled.section`
  ...
  .content {
    ...
    position: relative;
    background-image: url("https://crm-desarrollo.sfo3.digitaloceanspaces.com/templates/PROMED.jpeg");
    padding: 60px;
  }
