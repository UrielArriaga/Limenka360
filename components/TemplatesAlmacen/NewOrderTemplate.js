...
export default function NewOrderTemplate(props) {
  ...
  const { provider, products, folio = "N/A", buyer, address } = data;
        ...
        <div className="table-container2">
          <div className="table2">
            ...
            <div className="table-content2">
              ...
              <p className="text">
                ADDRESS: <span className="span_color"> {buyer?.address} </span>{" "}
              </p>
              <p className="text">
          ...
          <div className="div_data">
            <div className="div_dates">
              <p className="text_data">
                {" "}
                PROMED EXPORT SERVICES, LLC{" "}
                <span className="span_color_data"> MARICELA RODRIGUEZ unomedimagingsolutions@yahoo.com</span>{" "}
              </p>
              <p className="text_data">
                {" "}
                6324 S 23RD ST. MCALLEN, TX 78503 USA{" "}
                <span className="span_color_data"> PHONE: +9566273526 FX: 956-627-3576 ZIP: 78503</span>
              </p>
            </div>
          </div>
        </div>
