...
function MeisonGarantia(props) {
  const { zoom, data } = props;
  return (
    <LayoutStyleMeison zoom={zoom}>
     <div className="container">
            <div className="content">
              <div className="sectionParagraph">
                ...
                <p className="text">
                  MEISON MEDICAL Hace de su conocimiento que es responsabilidad del cliente reportar o notificar
                  ...
                  servicio de MEISON MEDICAL, dicha cita se tendrá que solicitar al correo:
                  garantias@solucioneshospitalarias.com.mx
                </p>
                <p className="text">
                  <strong>I.</strong> Esta póliza ampara únicamente productos comercializados por MEISON MEDICAL,
            ...
            <div className="content">
              <div className="sectionParagraph">
                ...
                <p className="text">MEISON MEDICAL garantiza durante el lapso de meses 12 MESES</p>
...
export default MeisonGarantia;

export const LayoutStyleMeison = styled.section`
  height: 100%;
  width: 100%;
  ...
  .content {
    ...
    background-position: center;
    position: relative;
    background-image: url("https://crm-desarrollo.sfo3.digitaloceanspaces.com/templates/backgroundMeison.jpeg");
}
