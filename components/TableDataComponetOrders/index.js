          ...
          <div className="content ">
            <div className="content__flex">
              ...
              <div className="icon-bg">
                <Tooltip title="Ver información completa Pedido">
            ...
            <div className="content__more">
              ...
              <p className="txt-createdAt">
                Creado <span>{getDiferrenceDates(itemData?.data?.createdAt)} </span>
              </p>
            </div>
          </div>
        </TableDataId>
    ...
    case "estado":
      return (
        <TableData isPar={isPar} isNew={isNew}>
          {item.status == 2 && (
            <div className="content order" style={{ background: "#097a09" }}>
          ...
          {item.status == 1 && (
            <div className="content order" style={{ background: "#e5ca0a" }}>
              <div className="order-title">
                <p>{item.name}</p>
              </div>
            </div>
          ...
          {item.status == 3 && (
            <div className="content order" style={{ background: "#bf1818" }}>
              <div className="order-title">
                <p>{item.name}</p>
              </div>
            </div>
          ...
          {item.status == 5 && (
            <div className="content order" style={{ background: "#407AFF" }}>
              <div className="order-title">
                <p>{item.name}</p>
              </div>
            </div>
...
const TableComponent = props => {
  ...
  const saveAndRetrivelocalStorage = () => {
    try {
      ...
      let savedHeads = localStorage.getItem("tableHeadsOrderEjecutive");
      if (savedHeads === null || savedHeads === undefined) {
        setHeadsTable(normalizeHeads);
        localStorage.setItem("tableHeadsOrderEjecutive", JSON.stringify(normalizeHeads));
      } else {
  ...
  const handleFuctionOptions = rowSelected => {
    handleClickEditOrder(rowSelected);
    handleCloseActionsRow();
  };
  const handleFuctionOptionsDiscarted = rowSelected => {
    handleClickDiscardOrder(rowSelected);
    handleCloseActionsRow();
  };
                  ...
                  <div>
                    <div className="content">
                      <div
                        ...
                        onClick={e => {
                          handleClickOpenActions(e, itemRow);
                        }}
                      >
                        <MoreVert />
                      </div>
                        ...
                        <div className="options">
                          ...
                          <div
                            ...
                            onClick={() => {
                              {
                                rowSelected.data.orderstatus.status === 3
                                  ? handleFuctionOptionsDiscarted(rowSelected)
                                  : handleGlobalAlert(
                                      "error",
                                      "Este pedido no puede ser descartado Solo puedes descartar pedidos rechazados",
                                      "basic",
                                      dispatch,
                                      6000
                                    );
