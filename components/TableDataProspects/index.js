...
const TableDataComponent = ({ item, headName, id, isPar, isNew, position }) => {
          ...
          >
            <StyledPopOver>
              <div className="popover">
                ...
                <Divider />
                <div onClick={() => setOpenWhats(true)} className="popover__item">
...
export const TableComponent = (props) => {
  const { heads, id, secondaryColor, primaryColor, data } = props;
  const {
      ...
      <Table>
        ...
        <TableBody>
          {data.map((item, indexRow) => {
            return (
              <TableRowBody key={item.id} isPar={indexRow % 2 == 0} isNew={indexRow == 1}>
                {heads.map((row, index) => {
                  if (headsTable[index].showColumn) {
                    return (
                      <TableDataComponent
                        ...
                        isPar={indexRow % 2 == 0}
                        key={row}
                        item={item[headsTable[index].headTextData]}
                ...
                <TableDataSettingsColumn isPar={indexRow % 2 == 0} {...colors} isNew={indexRow == 1}>
                  <div>
                    <div className="content">
                      <div
                        ...
                        onClick={(e) => handleClickOpenActions(e)}
                      >
                        <MoreVert />
                      </div>
                    </div>
                    ...
                    >
                      <div className="options">
                        ...
                        <div
                          className="options__option"
                          onClick={() => {
                            handleClickConverToOportunity(item);
                            handleCloseActionsRow();
                          }}
                        >
                          <AttachMoney />
                        ...
                        <div
                          className="options__option"
                          onClick={() => {
                            handleClickDiscardProspect(item);
                            handleCloseActionsRow();
                          }}
                        >
                          <Delete />
      ...
      {showTutorial ? (
        <div className="tutorial">
          ...
          <div className="description">
            <p>
              Ahora, puedes cambiar el orden de las columnas, solo manten presionda la columna que te interese
              mover
            </p>
          </div>
...
const normalizeTableProspect = (prospects) => {
  ...
  for (let i = 0; i < prospects.length; i++) {
    ...
    normalize["Etiquetas"] = element?.prospectslabels
