...
export const SalesManagerStyled = styled.div`
  width: 100%;
  display: flex;
  overflow: hidden;
...
`;
export const FiltersManagerSales = styled(Drawer)`
...
`;
export const AlertDateManager = styled.div`
...
`;
export const OptionExecutive = styled.div`
  .title {
    font-size: 13px;
    color: grey;
    .data {
