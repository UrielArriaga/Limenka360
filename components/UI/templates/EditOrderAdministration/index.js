...
import { EditOrderStyle, Error, TableProducts } from "./style";
...
export default function EditOrderAdministration() {
  ...
  const getDataOrders = async () => {
    try {
      ...
      let params = {
        include:
          "oportunity,oportunity.prospect,address,address.postal,address.city,address.entity,bill,bill.cfdi,bill.paymentmethod,bill.paymentway,bill.address,bill.taxregime,paymentaccount",
      };
          ...
          {isLoading ? (
            ...
            <>
              <div className="head_Orders">
                ...
                <p className="order__title" onClick={() => console.log("productos defauilt", company)}>
                  Pedido
                </p>
              </div>
