...
export default function CardManager({ item, showLoading, isMoney }) {
  if (showLoading) return <CardManagerLoader item={item} />;
      ...
      <div className="content">
        ...
        <div className="percentajes">
          ...
          <span className="before">
            {isMoney ? formatNumber(item?.totalbefore?.toFixed(2)) : item.totatotalbeforel}
          </span>
