...
import { formatDate, formatHour, formatLink } from "../../../../utils";
  ...
  const handleClickProspect = scrollTo => {
    if (isOportunity) {
      router.push({
        ...
        query: { prospecto: prospect.id, scrollTo: scrollTo },
      });
    } else {
...
export default DrawerOportunitiesAdmin;
