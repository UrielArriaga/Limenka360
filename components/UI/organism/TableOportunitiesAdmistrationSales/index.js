...
const TableComponent = props => {
  ...
  const saveAndRetrivelocalStorage = () => {
    try {
      ...
      let savedHeads = localStorage.getItem("tableOportunityAdministrationSales");
      localStorage.setItem("tableOportunityAdministrationSales", JSON.stringify(normalizeHeads));
      if (savedHeads === null || savedHeads === undefined) {
        ...
        if (lengthArray.length === heads.length) {
          ...
          localStorage.setItem("tableOportunityAdministrationSales", savedHeads);
        } else {
          setHeadsTable(normalizeHeads);
