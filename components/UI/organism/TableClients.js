                        ...
                        return (
                          <td className="data" key={ix}>
                            {typeof cell[ix] !== "object" && (
                              <p className="ctr_td">
                                {keyCell[ix]?.includes("email") || (keyCell[ix]?.includes("correo") && <MailOutline fontSize="small" className="icon_mail" />)}
                                {keyCell[ix]?.includes("phone") && cell[ix] !== "telefono" && <Smartphone fontSize="small" className="icon_telefono" />}
                                {keyCell[ix]?.includes("monto") || (keyCell[ix]?.includes("amount") && <AttachMoney fontSize="small" className="icon_phone" />)}
                                {keyCell[ix]?.includes("comision") || (keyCell[ix]?.includes("comission") && <AttachMoney fontSize="small" className="icon_phone" />)}
