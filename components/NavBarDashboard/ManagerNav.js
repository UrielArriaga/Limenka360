...
import { colors, customWidthNavBar } from "../../styles/global.styles";
...
const NavBarDashboardManager = ({ sideBar, isOpen }) => {
  ...
  const [drawerShowDiscount, setDrawerShowDiscount] = useState(false);
  ...
  return (
    <>
      <NavBarStyled sideBar={sideBar} isOpen={openMenuSide}>
        <div className="ctr_nav">
          ...
          <div className="ctr_nav__column2">
            <div className="ctr_nav__column2__ctr_icons">
              ...
              <div className="ctr_nav__column2__ctr_icons__icon" onClick={() => setDrawerShowDiscount(true)}>
        ...
        />
        <DrawerAutorization
          drawerShowDiscount={drawerShowDiscount}
          setDrawerShowDiscount={setDrawerShowDiscount}
