...
export default function MedicalbuyTemplate(props) {
  ...
  const { prospect, products, footer, total, ejecutive, subtotal, quoteInfo, discount, company, observations } = data;
      ...
      <div className="container_template">
        <div className="box">
          <div className="art_cabezera">
            <div className="logo">
              <img
                src="https://crm-desarrollo.sfo3.digitaloceanspaces.com/templates/medicalbuy.png"
                className="img_log"
              />
            </div>
