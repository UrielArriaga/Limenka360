...
import { NewProspectStyledAdd, Error } from "../../../../styles/Compras/proveedores/styles";
...
export default function NewProspect() {
  ...
  return (
    <MainLayout>
      <NewProspectStyledAdd>
        <div className="main">
          <div className="main_prospects">
            <div className="head">
              <div className="head__title">
                <Tooltip title="Regresar">
                  <ArrowBack className="arrow" onClick={() => router.push({ pathname: `/compras/productos` })} />
                </Tooltip>
