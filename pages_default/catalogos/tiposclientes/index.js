...
import TypeClientsTable from "../../../components/TableClientsTypes";
...
export default function Origins(page, isLoading, handleAlert, setAlert) {
  ...
  const navigateCreateNew = () => {
    router.push("../catalogos/tiposclientes/nuevo");
  };
        ...
        <div>
          {filterChanel !== "" && (
            <Chip
              ...
              label={`${"Buscando por tipo de cliente"}`}
              className="chip"
            />
          )}
          {searchKey && (
            <Chip
              ...
              label={`Buscando Tipo de cliente:  ${searchKey}`}
              className="chip"
            />
          )}
        </div>
  ...
  return (
    <DirectorLayout>
      <OriginStyled>
        <Head>
          <title>CRM JOBS - Tipo de clientes</title>
        </Head>
        {/* <SideBar />
          ...
          <div className="container">
            <div className="head">
              <div className="head__title">
                <div className="total">
                  <h1>
                    <PersonPinCircle className="icon" /> Tipos de clientes
                  </h1>
          ...
          <div className="ctr_drawer">
            ...
            <Grid container className="container" spacing={2}>
              <Grid item md={12} className="casilla">
                ...
                <label className="label2"> Buscar por tipo de cliente</label>
