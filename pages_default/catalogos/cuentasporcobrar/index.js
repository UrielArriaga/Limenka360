...
import PaymentAccountTable from "../../../components/TablePaymentsAccount";
...
export default function Phases(page) {
        ...
        <div>
          {searchKey && (
            <Chip
              ...
              label={`Buscando por Cuenta por cobrar: ${searchKey}`}
              className="chip"
            />
          )}
        </div>
  ...
  const navigateCreateNew = () => {
    router.push("../catalogos/cuentasporcobrar/nuevo");
  };
  return (
    <DirectorLayout>
      <FasesStyled>
          ...
          <div className="container">
            <div className="head">
              <div className="head__title">
                <div className="total">
                  <h1>
                    <DynamicFeed className="icon" /> Cuentas por cobrar
                  </h1>
            ...
            <div className="ctr_filter">
              <div className="ctr_filter__ctr_input">
                <TextField
                  ...
                  label={searchKey !== "" && "Buscar cuenta por cobrar"}
