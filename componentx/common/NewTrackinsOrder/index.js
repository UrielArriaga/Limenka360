...
import useComments from "../../../hooks/useNewComments";
import dayjs from "dayjs";
import { IconButton } from "@material-ui/core";

export default function NewTrackinsOrder({ orderData }) {
  const {
    commnents,
    isPosting,
    isFetching,
              ...
              <div className="columninfo">
                <div className="columninfo__header">
                  <p>
                    ...
                    {capitalizarString(item?.ejecutive?.title)} {capitalizarString(item?.ejecutive?.fullname)}
                  </p>
                </div>
