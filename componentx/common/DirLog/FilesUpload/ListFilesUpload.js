      ...
      {fileToUpload.length > 0 && (
        <div className="filestoupload">
          {fileToUpload.map((file, index) => {
            return (
              <div className="itemupload" key={index}>
                <Grid className="fileselected" container spacing={2}>
                  ...
                  <Grid item md={4}>
                    <Select
                      ...
                      options={userData?.roleId === "encargado_de_egresos" ? filetypes.results.filter(item => item.name === "Evidencia del producto ") : filetypes?.results}
