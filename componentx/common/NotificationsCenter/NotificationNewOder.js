...
import { markReadNotification, notificationsCenterSelector } from "../../../redux/slices/notificationcenterSlice";
import { userSelector } from "../../../redux/slices/userSlice";
export default function NotificationNewOder({ notif }) {
  ...
  return (
    <NotificationItem
      ...
      onClick={() => {
        ...
        dispatch(markReadNotification({ id: notif.id }));
      }}
    >
      <AvatarContainer>
        <Avatar
      ...
      <Content>
        <p className="fullname">
          <strong>{notif.metadata?.fullname} </strong> realizo un nuevo pedido, folio
